...
1. V. Arvind Rameshwar and Navin Kashyap, “**On the Performance of Reed-Muller Codes Over $(d,\infty)$-RLL Input-Constrained BMS Channels**,” accepted to the International Symposium on Information Theory (ISIT), Espoo, Finland, Jun. 2022. [[arXiv full version](https://arxiv.org/abs/2201.02035)]

2. V. Arvind Rameshwar and Navin Kashyap, “**Numerically Computable Lower Bounds on the Capacity of the $(1,\infty)$-RLL Input-Constrained Binary Erasure Channel**,” National Conference on Communications (NCC), 2021. **Recipient of a Best Paper Award**. [[IEEE Xplore](https://ieeexplore.ieee.org/document/9530025)]
...
6. V. Arvind Rameshwar and Navin Kashyap, “**Achieving secrecy capacity of minimum storage regenerating codes for all feasible (n, k, d) parameter values**,” in 2019 National Conference on Communications (NCC), pp. 1--6, 2019. [[arXiv](https://arxiv.org/abs/1902.09865)][[IEEE Xplore](https://ieeexplore.ieee.org/document/8732243)]
